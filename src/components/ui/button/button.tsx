...
export const buttonVariants = cva(
  ...
  // inspected compiled CSS, see tokens.css's note) that Tailwind v4's
  // `duration-*` utility -- unlike `ease-*`/`z-index-*` -- doesn't read
    ...
    return (
      ...
      >
        {asChild ? (
          ...
          // pass the consumer's child straight through, unmodified.
          children
        ) : (
          <>

        ...
        render={({ field: controllerField }) => (
          <div className="flex items-center gap-2">
            <Switch
              ...
              // Same standard as CheckboxField -- ui/switch.tsx is also a
              // <button role="switch">, not a native <input>: onCheckedChange
              // above stands in for onChange, and there's no text content
              // for paste/copy/cut/select to apply to.
